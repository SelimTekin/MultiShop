    ...
    public class FeatureSliderController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var values = JsonConvert.DeserializeObject<List<ResultFeatureSliderDto>>(jsonData); // json formatını metne çevir
                return View(values);
            }
            return View();
        }
        ...
        public async Task<IActionResult> CreateFeatureSlider(CreateFeatureSliderDto createFeatureSliderDto)
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "FeatureSlider", new { area = "Admin" }); // Admin areadaki FeatureSlider controller'ının Index sayfasına yönlendir
            }
            return View();
        }
        ...
        public async Task<IActionResult> UpdateFeatureSlider(string id)
        {
            ...
            {
                var jsonData = await responseMessage.Content.ReadAsStringAsync(); // gelen veriyi string formatta oku
                var values = JsonConvert.DeserializeObject<UpdateFeatureSliderDto>(jsonData); // json formatını metne çevir
                return View(values);
            }
            return View();
        }
