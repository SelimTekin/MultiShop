    ...
    public class BrandController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                ...
                var values = JsonConvert.DeserializeObject<List<ResultBrandDto>>(jsonData); // json formatını metne çevir
                return View(values);
            }
            return View();
        }
        ...
        public async Task<IActionResult> CreateBrand(CreateBrandDto createBrandDto)
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "Brand", new { area = "Admin" }); // Admin areadaki Brand controller'ının Index sayfasına yönlendir
            }
            return View();
        }
        ...
        public async Task<IActionResult> UpdateBrand(string id)
        {
            ...
            {
                var jsonData = await responseMessage.Content.ReadAsStringAsync(); // gelen veriyi string formatta oku
                var values = JsonConvert.DeserializeObject<UpdateBrandDto>(jsonData); // json formatını metne çevir
                return View(values);
            }
            return View();
        }
