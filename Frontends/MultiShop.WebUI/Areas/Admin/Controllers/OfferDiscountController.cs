...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class OfferDiscountController : Controller
    {
        ...
        public async Task<IActionResult> CreateOfferDiscount(CreateOfferDiscountDto createOfferDiscountDto)
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "OfferDiscount", new { area = "Admin" }); // Admin areadaki OfferDiscount controller'ının Index sayfasına yönlendir
            }
            return View();
        }
        ...
        public async Task<IActionResult> UpdateOfferDiscount(string id)
        {
            ...
            {
                var jsonData = await responseMessage.Content.ReadAsStringAsync(); // gelen veriyi string formatta oku
                var values = JsonConvert.DeserializeObject<UpdateOfferDiscountDto>(jsonData); // json formatını metne çevir
                return View(values);
            }
            return View();
        }
