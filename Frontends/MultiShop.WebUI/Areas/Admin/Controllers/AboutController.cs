...
namespace MultiShop.WebUI.Areas.Admin.Controllers
{
    ...
    public class AboutController : Controller
    {
        ...
        public IActionResult CreateAbout()
        {
            ViewBag.v1 = "Ana Sayfa";
            ViewBag.v2 = "Hakkımızda";
            ViewBag.v3 = "Yeni Hakkımızda Alanı Girişi";
            ViewBag.v0 = "Hakkımızda İşlemleri";
            return View();
        }
        [HttpPost]
        ...
        public async Task<IActionResult> CreateAbout(CreateAboutDto createAboutDto)
        {
            ...
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index", "About", new { area = "Admin" }); // Admin areadaki About controller'ının Index sayfasına yönlendir
            }
            return View();
        }
        ...
        public async Task<IActionResult> UpdateAbout(string id)
        {
            ...
            {
                var jsonData = await responseMessage.Content.ReadAsStringAsync(); // gelen veriyi string formatta oku
                var values = JsonConvert.DeserializeObject<UpdateAboutDto>(jsonData); // json formatını metne çevir
                return View(values);
            }
            return View();
        }
